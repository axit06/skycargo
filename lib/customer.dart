  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: backarrow(),
        centerTitle: true,
        title: Text("Customer",style: TextStyle(color: const Color(0xff1b1b1b),fontSize: 19,fontFamily: Fontfamaly.gilroyBold),),
        actions: [
          Row(
            children: [
              GestureDetector(
                onTap: (){
                  Get.to(Createprialert());
                },
                child: Container(
                  height: 35,
                  width: 63,
                  ...
                  child: InkWell(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text("Add",style: TextStyle(color: Colors.white,fontSize: 13,fontFamily: Fontfamaly.gilroyMedium),)
                      ],
                    ),
                  ),
                ),
